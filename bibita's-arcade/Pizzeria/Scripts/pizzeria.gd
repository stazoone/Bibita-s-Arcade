...
@onready var button_cheese: Button = $CanvasLayer/ButtonCheese
@onready var button_rucola: Button = $CanvasLayer/ButtonRucola
@onready var button_pepperoni: Button = $CanvasLayer/ButtonPepperoni
@onready var button_tomato: Button = $CanvasLayer/ButtonTomato
@onready var button_submit: Button = $CanvasLayer/ButtonSubmit
